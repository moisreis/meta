...
class UsersController < ApplicationController
  ...
  # @category *Read*
  #
  # Read:: This action retrieves and displays a paginated and searchable list of all users registered in the system.
  #        It allows administrators to find and review user accounts.
  #
  ...
  def index
    ...
    #               applying any search criteria passed by the user in the web address parameters (`params[:q]`).
    @q = User.ransack(params[:q])

    # Explanation:: This executes the search query, ensures distinct results, and then
    #               divides the complete list of users into pages of 20 items to improve performance and readability.
